  ...
  return (
    ...
    <Container style={{
      ...
      justifyContent: 'space-between',
        ...
        <CourseCard img={QULogo} courseTitle={'Course 1'} courseDescription={'Description of Course 1'} courseNum='MA-229' profName={'Professor Ruby'}/>
        ...
        <CourseCard img={QULogo} courseTitle={'Course 4'} courseDescription={'Description of Course 4'} courseNum='CSC-340' profName={'Professor Johnson'}/>
     </Container>
    </>
  )
}
